...
<br>
이러한 절차적 프로그래밍의 한계 때문에 "언어"가 개발되게 되었다.<br>
...
상술한 문제를 해결하기 위해, 에르허츠 다익스트라(Edsger Wybe Dijkstra)가 <br>
[GOTO문의_해로움](https://homepages.cwi.nl/~storm/teaching/reader/Dijkstra68.pdf)
이라는 논문을 저술하게 된다.<br>
